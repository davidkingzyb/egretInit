...
//GOOD LUCK
var GamePane = (function (_super) {
    __extends(GamePane, _super);
    function GamePane(birdNum) {
        _super.call(this);
        this.panegroup = [];
        this.score = 0;
        this.hearttime = 2;
    ...
    var __egretProto__ = GamePane.prototype;
    __egretProto__.teachtap1 = function () {
    ...
    __egretProto__.teachtap2 = function () {
    ...
    __egretProto__.initMonster = function () {
    ...
    __egretProto__.anmtMonster = function () {
    ...
    __egretProto__.monsterFire = function (Y, T) {
    ...
    __egretProto__.anmtMonsterBullet = function () {
    ...
    __egretProto__.test = function (o) {
    ...
    __egretProto__.birdFall = function () {
    ...
    __egretProto__.testKill = function (o) {
            ...
            for (var j = 0; j < this.monsterArr.length; j++) {
                if (tool.test2PointHit(o, this.monsterArr[j], 60)) {
                    ...
                    if (this.monsterArr[j]['life'] <= 0) {
                        ...
                        egret.Tween.get(deadmonster).to({ rotation: 90, y: tool.stageH + 100 }, 1000).call(function () {
                            this.removeChild(deadmonster);
                        }, this);
